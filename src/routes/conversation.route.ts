...
import { createPayload, updatePayload } from "./schemas/conversation.schemas";
import Service from "../services/conversation.service";

const httpResourcePath = "conversations";
const httpResourceName = "Conversations"
